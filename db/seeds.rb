...
User.create!(first_name: "Pietro", last_name: "Ventimiglia", photo:"../app/assets/images/IMG_2820.JPG", email: "pietro@lewagon.com", password: "123456", host: true)
