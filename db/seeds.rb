...
Studio.create!(name: "Dance Club", category: "dance studio", description: "The perfect place to dance", address: "Piazzale P. Genova,4", remote_photo_url: "http://dancestar.com.hk/image/catalog/home_banner/about_us.jpg", user: HOSTS.sample, price: 32 , city: "milan")
Studio.create!(name: "Club to Dance", category: "dance studio", description: "A good place to dance", address: "Corso Magenta, 52", remote_photo_url: "https://dancehubsb.org/wp-content/uploads/2018/07/gallery-big-studio-2.jpg", user: HOSTS.sample, price: 30, city: "milan")
