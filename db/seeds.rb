...
Studio.create!(name: "Dance Club", category: "dance studio", description: "The perfect place to dance", address: "corso magenta,9", remote_photo_url: "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80", user: HOSTS.sample, price: 32 , city: "milan")
